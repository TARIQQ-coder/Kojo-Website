...
import SushiBloom from '../assets/SushiBloom.png'
...
const projectData = [
  ...
  },
  {
    ...
    description:
      'Shopping-mart is an all-in-one online store where you can shop for everything you need—from groceries and electronics to fashion and home goods. With a user-friendly interface and secure checkout, Shopping-mart ensures fast, reliable delivery right to your doorstep, making shopping convenient, efficient, and hassle-free.',
    tech: ['Vite', 'React', 'TypeScript', 'TailwindCSS', 'Zustand'],
