  ...
  return (
    <div className="min-h-screen text-white font-mono scroll-smooth">
      <div>
        ...
        <section
          id="home"
          className="flex justify-center items-center h-screen bg-gradient-to-b from-[#010634] via-[#010634] to-black"
        >
        ...
        <section
          id="about"
          className=" bg-[linear-gradient(to_bottom,_black_0%,_black_55%,_#060022_100%)]"
        >
          <h1 className="text-center text-3xl">
            Why hire me for your{" "}
            <span className="bg-gradient-to-r from-violet-900 to-violet-400 bg-clip-text text-transparent font-semibold">
              next project?
            </span>
          </h1>
              ...
              <div className="border inline-block rounded-lg p-[3px] border-black bg-black  ">
                <div className="w-fit p-[4px] rounded-lg bg-gradient-to-b from-[#01275c] to-[#000232] overflow-hidden">
                  <img
                    ...
                    className="w-[280px] h-[390px] object-cover rounded-sm"
                  />
                </div>
              </div>
            </div>
        ...
        <section className=" bg-[linear-gradient(to_bottom,_#060022_0%,_#04032b_75%,_#04032b_100%)] pb-20">
          <h1 className="bg-gradient-to-r from-[#5667f6] to-[#c952ff] bg-clip-text text-transparent font-semibold text-4xl text-center">
                ...
                <div className="space-y-6">
                  {education.map((item, index) => (
                    <div className="bg-[#38334e]/40 w-[80%] rounded-md mx-auto py-4 pl-4 hover:bg-[#38334e]/75">
                      <p className="text-sm text-[#5667f6] font-semibold">
                        {item.date}
                      </p>
                      <p className="mb-2 text-lg">{item.title}</p>
                      <p className="text-[#d2cce9] font-semibold">
                        {item.organization}
                      </p>
                    </div>
                  ))}
        ...
        <section className="bg-[linear-gradient(to_bottom,_#04032b_0%,_#04032b_95%,_#04032b_100%)] ">
          <div className="mb-10">
            <p className="text-3xl font-semibold tracking-wide flex space-x-4 justify-center items-center">
              <span className=" bg-gradient-to-r from-[#5667f6] to-[#7634aa] bg-clip-text text-transparent text-4xl">
                Tools
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-25 md:px-33">
            {Tools.map((tool, index) => (
              <div
                key={index}
                className="bg-[#38334e]/40 w-[250px] h-[140px] rounded-md mx-auto py-6 flex flex-col items-center gap-2"
              >
                <div>
        ...
        <section
          id="skills"
          className=" bg-[linear-gradient(to_bottom,_#04032b_0%,_#04032b_35%,_black_100%)] pb-30"
        >
          <TechTags />
        </section>
        ...
        <section
          id="projects"
          className="bg-[linear-gradient(to_bottom,_black_0%,_black_90%,_#04032b_100%)] pb-20"
        >
          ...
          <div className="w-fit mx-auto my-10 bg-gradient-to-r from-[#5667f6] to-[#7634aa] text-white border border-white py-2 px-4 rounded-lg text-lg transition-transform duration-300 transform hover:scale-110 border-none cursor-pointer">
            <button
              onClick={() =>
                window.open(
                  "https://github.com/TARIQQ-coder?tab=repositories",
                  "_blank"
                )
              }
        ...
        <section className="bg-[linear-gradient(to_bottom,_#04032b_0%,_black_75%,_black_100%)] pb-20">
          ...
          <div className="px-8 grid grid-cols-1 gap-y-10">
            <div className=" bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 shadow-lg hover:bg-white/20 transition-transform duration-300 transform hover:scale-105 border-none">
              <p className="text-2xl bg-gradient-to-r from-[#5667f6] to-[#a647ee] bg-clip-text text-transparent font-semibold mb-4">
                Did you know that a website's performance can be the difference
                between gaining or losing a client?
              </p>

              <span className="text-lg">
                In today's digital-first world, your website is often the first
                (and sometimes only) impression you get to make. Whether you're
                a developer, designer, business owner, or marketer, website
                performance is not just a technical detail—it's a strategic
                asset that can directly influence whether you win or lose a
                potential client.
              </span>
              ...
              <div className="w-fit bg-gradient-to-r from-[#5667f6] to-[#7634aa] text-white border border-white py-2 px-4 rounded-lg  border-none cursor-pointer tracking-wide mt-4">
                <button
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/pulse/website-performance-difference-between-gaining-losing-kojo-amfo-baah-necye/",
                      "_blank"
                    )
                  }
                  className="cursor-pointer"
            ...
            <div className=" bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 shadow-lg hover:bg-white/20 transition-transform duration-300 transform hover:scale-105 border-none">
              <p className="text-2xl bg-gradient-to-r from-[#5667f6] to-[#a647ee] bg-clip-text text-transparent font-semibold mb-4">
                The Importance of Versioning Your Code: A Practical Guide to Git
                and GitHub
              </p>

              <span className="text-lg">
                In the fast-evolving world of software development, writing good
                code is only part of the equation. Equally important is how you
                manage and track that code over time. Whether you're working
                solo or in a team, version control is the safety net that
                protects your project's integrity and your sanity.
              </span>
              ...
              <div className="w-fit bg-gradient-to-r from-[#5667f6] to-[#7634aa] text-white border border-white py-2 px-4 rounded-lg  border-none cursor-pointer tracking-wide mt-4">
                <button
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/pulse/importance-versioning-your-code-practical-guide-git-github-amfo-baah-ptjoe/",
                      "_blank"
                    )
                  }
                  className="cursor-pointer"
            ...
            <div className=" bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 shadow-lg hover:bg-white/20 transition-transform duration-300 transform hover:scale-105 border-none">
              <p className="text-2xl bg-gradient-to-r from-[#5667f6] to-[#a647ee] bg-clip-text text-transparent font-semibold mb-4">
                The Benefits of AI for Developers — And Why You Shouldn't Rely
                on It Entirely
              </p>

              <span className="text-lg">
                Artificial Intelligence has rapidly become a vital tool in the
                software development process. From autocomplete suggestions to
                full-blown code generation, AI is helping developers write
                better code, faster. It's transforming the way we build, debug,
                and deploy software — and it's not slowing down anytime soon.
              </span>
              ...
              <div className="w-fit bg-gradient-to-r from-[#5667f6] to-[#7634aa] text-white border border-white py-2 px-4 rounded-lg  border-none cursor-pointer tracking-wide mt-4">
                <button
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/pulse/benefits-ai-developers-why-you-shouldnt-rely-entirely-kojo-amfo-baah-wb2xe/",
                      "_blank"
                    )
                  }
                  className="cursor-pointer"
        ...
        <section
          className="bg-[linear-gradient(to_bottom,_black_0%,_black_75%,_black_100%)]"
          id="contact"
        >
        ...
        <section className="bg-[linear-gradient(to_bottom,_black_0%,_black_75%,_black_100%)]">
          <div className="flex justify-center gap-8 ">
            <div className="cursor-pointer">
              <a
                href="https://x.com/Tariqq_gunner"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="cursor-pointer">
              <a
                href="https://www.instagram.com/riqque_1/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="cursor-pointer">
              <a
                href="https://www.linkedin.com/in/kojo-amfo-baah-206191228/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <div className="cursor-pointer">
              <a
                href="https://www.youtube.com/@pidginplaybook"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <div className="flex justify-center py-4">
            <p>
              &copy; {new Date().getFullYear()} Kojo Amfo-Baah. All rights
              reserved.
            </p>
          </div>
        </section>
