    ...
    <nav className="bg-[#010634] text-white py-2 border-b border-[#2E2E62] fixed top-0 w-full z-40">
      <div className="container mx-auto flex justify-between items-center px-4 py-2">
        ...
        <div className="md:flex hidden space-x-16 text-lg font-light">
          <a
            href="#home"
            className="text-[#A084CA]  flex items-center hover:bg-[#535379] hover:text-white p-2 rounded "
          >
          ...
          <a
            href="#skills"
            className="text-[#A084CA] hover:bg-[#535379] hover:text-white p-2 rounded  flex items-center"
          >
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col space-y-2 p-4">
          <a
            href="#home"
            className="text-[#A084CA] hover:bg-[#535379] hover:text-white p-2 rounded w-fit flex items-center"
          >
            <FaHome className="mr-1" /> Home
          </a>
          <a
